...
const Invoices = () => {
  ...
  const { invoices, isLoading, isError, message } = useSelector((state) => state.pos);
    ...
    <Layout>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-[rgb(var(--color-text))] mb-2">Invoices</h1>
          <p className="text-gray-600 dark:text-[rgb(var(--color-text-secondary))]">View and manage all invoices</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
          ...
          <div className="bg-white dark:bg-[rgb(var(--color-card))] rounded-xl shadow-sm dark:shadow-lg border dark:border-[rgb(var(--color-border))] p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-500 dark:text-[rgb(var(--color-text-secondary))] text-sm font-medium">Total Sales</p>
                <p className="text-3xl font-bold text-gray-900 dark:text-[rgb(var(--color-text))] mt-2">₹{totalSales.toFixed(0)}</p>
              </div>
        ...
        <div className="bg-white dark:bg-[rgb(var(--color-card))] rounded-xl shadow-sm dark:shadow-lg border dark:border-[rgb(var(--color-border))] overflow-hidden">
          {isLoading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 dark:text-[rgb(var(--color-text-secondary))] text-lg">No invoices found</p>
              <button
                onClick={() => navigate('/pos')}
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-gray-50 dark:bg-[rgb(var(--color-table-header))] border-b border-gray-200 dark:border-[rgb(var(--color-border))]">
                  <tr>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-[rgb(var(--color-text-secondary))] uppercase">Invoice No</th>
                    ...
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-[rgb(var(--color-text-secondary))] uppercase">Items</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-[rgb(var(--color-text-secondary))] uppercase">Total</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-[rgb(var(--color-text-secondary))] uppercase">Paid</th>
                    ...
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-[rgb(var(--color-text-secondary))] uppercase">Payment</th>
                    <th className="px-6 py-3 text-right text-xs font-medium text-gray-500 dark:text-[rgb(var(--color-text-secondary))] uppercase">Actions</th>
                  </tr>
                </thead>
                <tbody className="bg-white dark:bg-[rgb(var(--color-table-row))] divide-y divide-gray-200 dark:divide-[rgb(var(--color-border))]">
                  {filteredInvoices.map((invoice) => (
                    <tr key={invoice._id} className="hover:bg-gray-50 dark:hover:bg-[rgb(var(--color-input))]">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm font-medium text-indigo-600 dark:text-[rgb(var(--color-primary))]">{invoice.invoiceNo}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <td className="px-6 py-4">
                        ...
                        {invoice.customer?.phone && (
                          <div className="text-xs text-gray-500 dark:text-[rgb(var(--color-text-secondary))]">{invoice.customer.phone}</div>
                        )}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-900 dark:text-[rgb(var(--color-text))]">{invoice.items.length} items</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-900 dark:text-[rgb(var(--color-text))]">₹{invoice.paidAmount.toFixed(2)}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className="text-sm text-gray-900 dark:text-[rgb(var(--color-text))] capitalize">{invoice.paymentMethod}</span>
                      </td>
